...
<div class="col-md-12">
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header" style="font-weight: bold;">{{ __('Payment Details') }}
        ...
        <thead>
           ...
           <tbody>
            <tr>
            <td>{{$data->momo_account_name}}</td>
            <td>{{$data->momo_account_number}}</td> 
            ...
            <td>
            <a href = 'AdminEditPayment/{{$data->id}}'>
