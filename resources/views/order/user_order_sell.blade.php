...
<div class="col-md-12">
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header" style="font-weight: bold;">{{ __(' Sold Orders') }}
        ...
        <thead>
            ...
            @foreach($data_selling as $data)
           <tbody>
            <tr>
            <td>{{$data->amount_selling}} .00 USD</td> 
            <td>{{$data->total_amount_to_pay}} GHS</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <!-- <div class="col-sm-6"> -->
                   <label style=" margin-bottom: 1px; display: block;color:#008080" for="contact"><span style="color:black;font-style:italic"></span>Amount Sold</label>
                  <input type="text" name="momo_name" id="momo_name" class="form__input" placeholder="Your Account Name" autocomplete="off" value="{{$data->amount_selling}}.00 USD">

                  <label style=" margin-bottom: 1px; display: block;color:#008080" for="contact"><span style="color:black;font-style:italic"></span>Payment Amoiunt</label>
                  <input type="text" name="momo_name" id="momo_name" class="form__input" placeholder="Your Account Name" autocomplete="off" value="{{$data->total_amount_to_pay}} GHS">
            ...
            @if($data->bank_account_name == null)
                  ...
                  <input type="text" name="momo_name" id="momo_name" class="form__input" placeholder="Your Account Name" autocomplete="off" value="{{$data->momo_account_name}}">
                  ...
                  <input type="text" name="momo_name" id="momo_name" class="form__input" placeholder="Your Account Name" autocomplete="off" value="{{$data->momo_account_number}}">
            @else
                  ...
                  <input type="text" name="momo_name" id="momo_name" class="form__input" placeholder="Your Account Name" autocomplete="off" value="{{$data->bank_account_name}}">
                  ...
                  <input type="text" name="momo_name" id="momo_name" class="form__input" placeholder="Your Account Name" autocomplete="off" value="{{$data->bank_account_number}}">
                  ...
                  <input type="text" name="momo_name" id="momo_name" class="form__input" placeholder="Your Account Name" autocomplete="off" value="{{$data->bank_name}}">
                  ...
                  <input type="text" name="momo_name" id="momo_name" class="form__input" placeholder="Your Account Name" autocomplete="off" value="{{$data->bank_branch}}">
                </div>
            @endif
                  <!-- </div><br> -->
