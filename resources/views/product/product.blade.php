...
<div class="col-md-12">
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header" style="font-weight: bold;">{{ __('Product') }}
        ...
        <thead>
           ...
           <tbody>
            <tr>
            <td><img src="{{$data->product_logo}}" height=20px width=20px></td> 
            <td>{{$data->name}}</td>
            <td>{{$data->price}}</td> 
            <td>{{$data->change_value}}</td>
            <td>{{$data->status}}</td>
            <td>{{ \Carbon\Carbon::parse($data->created_at)->diffForHumans() }}</td>

            <td>
            <a href = 'AdminEditProduct/{{$data->id}}'>
