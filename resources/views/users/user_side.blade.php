...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <div class="header">
            ...
            <a style="font-family: 'Montserrat', sans-serif;color:#008080" title="buy crypto" href="buying"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Buy</a>

            <a style="font-family: 'Montserrat', sans-serif;color:#008080" title="sell crypto" href="selling"><i class="fa fa-shopping-basket" aria-hidden="true"></i> Sell</a>
            ...
            <div style="display: none;">
                    <a style="font-family: 'Montserrat', sans-serif;color:#008080" href="user_order_sell" title="sold crypto"><i class="fa fa-shopping-basket"></i> Sold Orders</a>
                    <a style="font-family: 'Montserrat', sans-serif;color:#008080" href="user_order_buy" title="bought crypto"><i class="fa fa-shopping-cart"></i> Bought Orders</a>
                </div>
            ...
            <div style="display: none;">
                    <a style="font-family: 'Montserrat', sans-serif;color:#008080" href="user_account" title="user account"><i class="fa fa-user"></i> Account</a>
                    <a style="font-family: 'Montserrat', sans-serif;color:#008080" href="UserChangePassword/{Auth::user()->id}" title="New Password"><i class="fa fa-key"></i> Change Password</a>
                </div>
