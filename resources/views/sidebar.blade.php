        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="navbar-nav ms-auto">
                    ...
                    <a style="padding-left:30px;font-size:18px;background-color: #6633fd;color:white;border-radius: 20px;border: none;outline: none;font-weight: 600;transition: all 0.5s ease;" href="upp" class="nav-item nav-link"><span style="padding-right:15px;text-align:center">Get Started</span></a>
                </div>
            </div>
        </div>
    </nav>
