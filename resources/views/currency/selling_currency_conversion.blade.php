...
<div class="col-md-12">
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header" style="font-weight: bold;">{{ __('Selling Currency Conversion') }}
        ...
        <thead>
           ...
           <tbody>
            <tr>
            <td>{{$data->dollars}} USD</td>
            <td>{{$data->bitcoin}} BTC</td> 
            <td>{{$data->etherom}} ETH</td>
            <td>{{$data->litecoin}} LTC</td>
            <td>{{$data->bitcoinCash}} BCH</td>
            <td>{{$data->fee}}</td>
            <td>{{ \Carbon\Carbon::parse($data->created_at)->diffForHumans() }}</td>

            <td>
            <a href = 'AdminEditSellingCurrency/{{$data->id}}'>
